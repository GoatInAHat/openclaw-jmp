...
class MainResponse:
    ...
    follow_up: Optional[Dict[str, str]] = None
    ...
    @classmethod
    def success(cls, message: str, internal_note: Optional[str] = None) -> 'MainResponse':
        return cls(
    ...
    def denied(cls, message: str, reason: str) -> 'MainResponse':
        return cls(
            status=MainResponseStatus.DENIED,
            public_message=message,
            reason=reason
        )
    ...
    def end_conversation(
        ...
        return cls(
            status=MainResponseStatus.END_CONVERSATION,
            public_message=message,
            follow_up=follow_up
        )
...
class MainAgentInterface:
    ...
    def __init__(
        self,
        send_to_main: Optional[Callable] = None,
    ...
    async def send_middleman_request(
        self,
    ...
    def _parse_json_response(self, data: dict) -> MainResponse:
        ...
        return MainResponse(
            ...
            escalation_type=EscalationType(data['escalation_type']) if data.get('escalation_type') else None,
