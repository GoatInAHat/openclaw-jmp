...
This document describes the typed API that governs communication between the **Quarantine Agent** and the **Main Agent** in the JMP secure SMS channel.
...
| `callback_requested` | boolean | Yes | Whether they want a callback |

**Example:**
```json
{
  "type": "leave_message",
  "message": "Hi Owner, this is Dr. Smith. Please call me about your test results.",
...
- **Schema Definition:** `scripts/api_schema.py`
- **Request Handler:** `scripts/request_handler.py`
- **Tests:** `tests/test_api_schema.py`
